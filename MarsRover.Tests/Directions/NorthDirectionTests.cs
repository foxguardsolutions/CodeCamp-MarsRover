...
{
    [TestFixture]
    public class NorthDirectionTests : DirectionTests
    {
        ...
        [Test]
        public void MoveBackward_GivenRandomPointOnGrid_MovesToSouthPosition()
        {
        ...
        [Test]
        public void MoveForward_GivenRandomPointOnGrid_MovesToNorthPosition()
        {
